...
public class FontBin {
    ...
    public void setFontBin(Font fontModel) {
    ...
    public String toString() {
        return "Font{" + "fontKey=" + fontKey + ", name='" + name + '\'' + ", enName='" + enName + '\'' + ", description='" + description + '\'' + ", copyright='" + copyright + '\'' + ", trademark='" + trademark + '\'' + ", license='" + license + '\'' + ", createTime=" + createTime + ", updateTime=" + updateTime + ", infoUpdateTime=" + infoUpdateTime + ", syncTime=" + syncTime + ", gbkCount=" + gbkCount + ", count=" + count + ", userId=" + userId + ", isRecommend=" + isRecommend + '}';
    }
